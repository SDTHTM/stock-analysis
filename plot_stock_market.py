...
see:
  ...
  http://scikit-learn.org/stable/_downloads/plot_stock_market.py
=======================================
...
# 2015jan28: cls: anything after 2008 does NOT work!
#                 why ??? coz some of stocks are missing
# this error occurs when a ticker is not found within the date range (d1 to d2):
# Traceback (most recent call last):
#   File "plot_stock_market.py", line 178, in <module>
#     open = np.array([q.open for q in quotes]).astype(np.float)
# ValueError: setting an array element with a sequence.
# ... how to handle this, other than commenting out the ticker symbol ???
...
cls1 = datetime.datetime(2004, 1, 1)
cls2 = datetime.datetime(2014, 1, 1)
...
# quotes_historical_yahoo_ochl, which maintains the original argument order:
quotes = [finance.quotes_historical_yahoo_ochl(symbol, d1, d2, asobject=True) for symbol in symbols]
# quotes_historical_yahoo_ohlc, which uses the open-high-low-close order:
# quotes = [finance.quotes_historical_yahoo_ohlc(symbol, d1, d2, asobject=True) for symbol in symbols]
